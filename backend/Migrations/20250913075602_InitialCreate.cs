        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseFareMultiplier = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Flights_Stations_DestinationStationId",
                        column: x => x.DestinationStationId,
                        principalTable: "Stations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Flights_Stations_SourceStationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TrainSchedules_Stations_DestinationStationId",
                        column: x => x.DestinationStationId,
                        principalTable: "Stations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TrainSchedules_Stations_SourceStationId",
                        column: x => x.SourceStationId,
                        principalTable: "Stations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Flights_DestinationStationId",
                table: "Flights",
                column: "DestinationStationId");

            migrationBuilder.CreateIndex(
                name: "IX_Flights_FlightNumber_TravelDate",
                table: "Flights",
                columns: new[] { "FlightNumber", "TravelDate" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Flights_SourceStationId",
                table: "Flights",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainSchedules_DestinationStationId",
                table: "TrainSchedules",
                column: "DestinationStationId");

            migrationBuilder.CreateIndex(
                name: "IX_TrainSchedules_SourceStationId",
                table: "TrainSchedules",
                column: "SourceStationId");
